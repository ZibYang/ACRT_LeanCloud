...
//            let model3 = ModelAnchor(modelName: "AppleLogo.usdz", pos: simd_float3(4.05483, 0.582852, 0.191444), rotation: rotationMatrix, scale: simd_float3(0.4,0.4,0.4))
    ...
    func initializeInherentModelsQiuShiSensetime() {
        ...
        let model1 = ModelAnchor(modelName: "qs_AppStore.usdz", pos: simd_float3(62.734833, -1.281104, -0.013874), rotation: rotationMatrix, scale: simd_float3(30,30,30))
         let model2 = ModelAnchor(modelName: "qs_AppleLogo_right.usdz", pos: simd_float3(57.134, 3.7623, 1.928), rotation: rotationMatrix, scale: simd_float3(50,50,50))
         let model3 = ModelAnchor(modelName: "qs_AppleLogo_left.usdz", pos: simd_float3(61.406, 12.7623, 1.928), rotation: rotationMatrix, scale: simd_float3(1,1,1))
         ...
         let model7 = ModelAnchor(modelName: "qs_Title.usdz", pos: simd_float3(55.291, 8.356, 9.2607), rotation: rotationMatrix, scale: simd_float3(15,15,15))
